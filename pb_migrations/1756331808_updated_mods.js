...
migrate((app) => {
  ...
  unmarshal({
    "listRule": "(isPublic = true && publicApprovalStatus = 'approved') || (@request.auth.id = createdBy)",
    "viewRule": "(isPublic = true && publicApprovalStatus = 'approved') || (@request.auth.id = createdBy)"
  }, collection)
